...
#define X64_SYSCALLS { \
    ...
    [102] = { "getuid", { UNKNOWN }, INT }, \
    [103] = { "syslog", { INT, STR, INT }, INT }, \
    [104] = { "getgid", { UNKNOWN }, INT }, \
    [105] = { "setuid", { INT }, INT }, \
    [106] = { "setgid", { INT }, INT }, \
    [107] = { "geteuid", { UNKNOWN }, INT }, \
    [108] = { "getegid", { UNKNOWN }, INT }, \
    [109] = { "setpgid", { INT, INT }, INT }, \
    [110] = { "getppid", { UNKNOWN }, INT }, \
    [111] = { "getpgrp", { UNKNOWN }, INT }, \
    [112] = { "setsid", { UNKNOWN }, INT }, \
    ...
    [152] = { "munlockall", { UNKNOWN }, INT }, \
    [153] = { "vhangup", { UNKNOWN }, INT }, \
    ...
    [184] = { "tuxcall", { UNKNOWN }, INT }, \
    [185] = { "security", { UNKNOWN }, INT }, \
    [186] = { "gettid", { UNKNOWN }, INT }, \
    ...
    [219] = { "restart_syscall", { UNKNOWN }, INT }, \
